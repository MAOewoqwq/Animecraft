...
// The Chinese model often emits full-width command punctuation (e.g. ！goToPlayer（"x"，3）)
// instead of ASCII, so the command regex misses it and the "command" gets spoken as plain
// text with no action. Normalize the full-width forms to ASCII before parsing.
export function normalizeCommandSyntax(message) {
